...
const mobileHome = mobileHomes[0];
const otherMobileHome = mobileHomes[1];
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/mobil-home-1`,
  },
};

export default function MobilHome1Page() {
  return (
    <>
      <JsonLd
        additionalData={{
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Le Panorama est situé à Corte, au cœur de la Haute-Corse. À quelques
                minutes des gorges de la Restonica, de la citadelle et du centre-ville historique.
              </p>
              <Link
                href="/localisation"
