    ...
    <section className="py-24 bg-gray-50/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 rounded-full border border-yellow-200/60 bg-yellow-50 px-4 py-2 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          {testimonials.map((t, i) => (
            <article
              key={i}
              className="card-surface reveal-on-scroll p-7 border border-gray-100/90"
            >
